              ...
              <CardContent className="grid pt-6">
                <div className="relative z-10 flex flex-col justify-between space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <span className="inline-block rounded bg-blue-200 px-2 py-1 text-xs font-medium text-blue-800 dark:bg-primary dark:text-blue-100">
                      Coming Soon
                    </span>
                    <p className="text-foreground">
                      Easily share documents, images, and videos with secure,
                      fast transfers.
                    </p>
                  </div>
                </div>
            ...
            <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <Video className="m-auto size-6" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium transition">
